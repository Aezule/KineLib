 ...
 */
final class Version20240113000830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prendre (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, kine_id INT DEFAULT NULL, date_rdv DATETIME NOT NULL, UNIQUE INDEX UNIQ_D2CA36CDA1CF58F3 (date_rdv), INDEX IDX_D2CA36CD19EB6921 (client_id), INDEX IDX_D2CA36CD88DC4BCC (kine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
